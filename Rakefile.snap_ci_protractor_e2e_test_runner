# Modification of https://github.com/platanus/blog/blob/7602d4f4a783eb1412e5ff28f4957ce31e19b0f2/_posts/2014-03-29-e2e-usando-rails-y-protractor.md

# Run Protractor tests on Snap-CI

# Create a stage with the following tasks:
  # bundle install --path /tmp/.bundle
  # bundle exec rake db:reset
  # bundle exec rake app:ptor:run

# Rails 4.1.4 | Ruby 2.1.5 | AngularJS 1.2.25 | Bower 1.3.9
  ...
  module Protractor
    ...
    private
      ...
      def self.run_tests
        ...
        system("node_modules/protractor/bin/protractor spec/javascripts/protractor.conf.js")
      end
